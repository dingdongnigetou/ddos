...
static void memory_map(volatile unsigned long *table)
{
	...
	/* va: 0x00000000 => pa: 0 */
	table[0x000] = 0 | MMU_SECDESC_USER;  
	 ...
	 */
	for (i = 0; i < 256; i++)
		table[0x100 + i] = (0x70000000 + (i << 20)) | MMU_SECDESC_NCNB;

	table[0xC00] = 0x50000000 | MMU_SECDESC_USER;
	table[0xC01] = 0x50100000 | MMU_SECDESC_USER;
	table[0xC02] = 0x50200000 | MMU_SECDESC_USER;
	table[0xC03] = 0x50300000 | MMU_SECDESC_USER;
	table[0xC04] = 0x50400000 | MMU_SECDESC_USER;
	table[0xC05] = 0x50500000 | MMU_SECDESC_USER;
	table[0xCF0] = 0x5F000000 | MMU_SECDESC_USER;
}
